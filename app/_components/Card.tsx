...
export default function Card({ item }: IProps) {
    return (
        <Link href={`/news/detail/${item.id}/`} className="block w-full h-full">
            <article className="h-full w-full flex flex-col gap-[10px]">
                <Image
                ...
                />
                <div className="flex flex-1 flex-col pt-0 2xl:pt-[10px] gap-[10px] lg:gap-[15px]">
                    ...
                    <div className="flex flex-row justify-between mt-auto">
                        <h2 className="md:text-[13px] lg:text-[19px] 2xl:text-[20px] font-bold text-secondery">
                            {item.category}
                        </h2>
                        <time
