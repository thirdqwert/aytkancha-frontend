                        ...
                        >
                            ...
                            <div className="px-[30px] pt-[30px] pb-[40px]">
                                <div className="flex flex-col gap-[5px] pb-[20px]">
                                    <span className="block text-[24px] font-medium text-[#818a93]">
                                        Elektron pochta
                                    </span>
                                    <span className="block text-primery text-[26px] font-medium">
                                        Aytkancha@gmail.com
                                    </span>
                                </div>
                                <div className="flex flex-col gap-[5px]">
                                    <span className="block text-[24px] font-medium text-[#818a93]">Telefon raqami</span>
                                    <span className="block text-primery text-[26px] font-medium">(32)333-33-44</span>
                                </div>
                            </div>
                        </div>
                        <div
